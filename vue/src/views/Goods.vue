...
<!--        <el-button type="primary">导出 <i class="el-icon-top"></i></el-button>-->
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="headerBg"
      ...
      <el-table-column prop="userId" label="上架用户id">
      </el-table-column>
      <el-table-column prop="nickname" label="上架用户">
      </el-table-column>
      <el-table-column prop="state" label="商品状态">
      </el-table-column>
      <el-table-column label="操作" width="250" align="center">
        <template slot-scope="scope">
          <el-button type="primary" @click="handleExam(scope.row)">审核<i class="el-icon-edit"></i></el-button>
