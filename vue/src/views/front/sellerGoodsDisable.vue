...
<!--              icon-color="red"-->
<!--              title="您确定下架吗？"-->
<!--              @confirm="handleDisable(scope.row)"-->
<!--          >-->
<!--            <el-button style="margin: 10px" slot="reference" type="danger" >下架<i class="el-icon-remove-outline"></i></el-button>-->
<!--          </el-popconfirm>-->
<!--&lt;!&ndash;          <el-button slot="reference" type="danger" @click="handleAfterSales(scope.row)">售后<i class="el-icon-remove-outline"></i></el-button>&ndash;&gt;-->
<!--&lt;!&ndash;          <el-button slot="reference" type="danger" @click="handleEvaluate(scope.row)" >下架<i class="el-icon-remove-outline"></i></el-button>&ndash;&gt;-->
<!--        </template>-->
<!--      </el-table-column>-->
...
export default {
  ...
  methods:{
    handleDisable(row){
      ...
      this.request.post("/goods/success/updateState",form).then(res =>{
        // console.log(res)
        if(res.code === '200'){
