...
<!--          <el-button type="success" @click="handleEdit(scope.row)">编辑<i class="el-icon-edit"></i></el-button>-->
          ...
          >
            <el-button slot="reference" type="danger" >确收<i class="el-icon-remove-outline"></i></el-button>
          </el-popconfirm>
        </template>
      </el-table-column>
    </el-table>
...
<!--        <i class="el-icon-coin"></i>一键确认收货</el-button>-->
<!--    </div>-->



<!--    <el-dialog title="确认支付" :visible.sync="payDialogFormVisible" width="60%" :show-close="false">-->
...
export default {
  ...
  methods:{
    ...
    //           seller = {
    //             id:item.userId,
    //             account:item.totalPrice
    //           }
    //           this.request.post("/user/updateSellerAccount", seller).then(res => {
    //             if(res.code === '200'){
    ...
    //             type:"收款",
    //           }
    //           this.request.post("/consum-records", accountForm).then(res => {
    //             if(res.code === '200'){
    //               // this.$message.success("支付成功")
    //             }else {
    //               this.$message.error(res.msg)
