...
<!--          <el-button type="success" @click="handleEdit(scope.row)">编辑<i class="el-icon-edit"></i></el-button>-->
          ...
          >
            <el-button slot="reference" type="danger" >更新物流<i class="el-icon-remove-outline"></i></el-button>
          </el-popconfirm>
        </template>
      </el-table-column>
    </el-table>
...
<!--      -->
      ...
      >
        <el-button slot="reference" size="medium" type="danger" >更新物流信息<i class="el-icon-remove-outline"></i></el-button>
      </el-popconfirm>
