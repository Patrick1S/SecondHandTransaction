...
<!--          <el-button type="success" @click="handleEdit(scope.row)">编辑<i class="el-icon-edit"></i></el-button>-->
          ...
          <el-button slot="reference" type="danger" @click="handleAfterSales(scope.row)">驳回<i class="el-icon-remove-outline"></i></el-button>
          <el-button slot="reference" type="success" @click="handleEvaluate(scope.row)" >通过<i class="el-icon-remove-outline"></i></el-button>
        </template>
      </el-table-column>
    </el-table>
...
<!--&lt;!&ndash;                @selection-change="handleSelectionChange($event,item.id)"&ndash;&gt;-->
<!--&lt;!&ndash;                :ref="`tableNow${item.id}`"&ndash;&gt;-->
<!--&lt;!&ndash;        <el-table-column&ndash;&gt;-->
<!--&lt;!&ndash;            type="selection"&ndash;&gt;-->
<!--&lt;!&ndash;            width="55"&ndash;&gt;-->
<!--&lt;!&ndash;            :reserve-selection = "true"&ndash;&gt;-->
<!--&lt;!&ndash;        >&ndash;&gt;-->
<!--&lt;!&ndash;        </el-table-column>&ndash;&gt;-->
<!--        &lt;!&ndash;      <el-table-column prop="id" label="ID" width="80"></el-table-column>&ndash;&gt;-->
<!--        &lt;!&ndash;      <el-table-column prop="goodsId" label="商品id" ></el-table-column>&ndash;&gt;-->
...
<!--          <template slot-scope="scope">-->
<!--&lt;!&ndash;            <el-input-number size="small" v-model="scope.row.num" :min="0" :max="scope.row.store" label="" @change="changeNum(scope.row)"></el-input-number>&ndash;&gt;-->
...
<!--        &lt;!&ndash;      <el-table-column prop="username" label="用户名称" ></el-table-column>&ndash;&gt;-->

<!--&lt;!&ndash;        <el-table-column prop="transport" label="交易方式"></el-table-column>&ndash;&gt;-->
<!--&lt;!&ndash;        <el-table-column prop="time" label="加入购物车时间" ></el-table-column>&ndash;&gt;-->
...
<!--      <el-button style="text-align: right; margin-top: 30px" type="danger" @click=" finishEvaluate()">确认评价<i class="el-icon-remove-outline"></i></el-button>-->
...
<!--        </el-form-item>-->
<!--&lt;!&ndash;        <el-form-item label="单位" >&ndash;&gt;-->
<!--&lt;!&ndash;          <el-input v-model="form.unit" autocomplete="off"></el-input>&ndash;&gt;-->
<!--&lt;!&ndash;        </el-form-item>&ndash;&gt;-->
<!--&lt;!&ndash;        <el-form-item label="库存" >&ndash;&gt;-->
<!--&lt;!&ndash;          <el-input v-model="form.store" autocomplete="off"></el-input>&ndash;&gt;-->
<!--&lt;!&ndash;        </el-form-item>&ndash;&gt;-->
<!--        &lt;!&ndash;        <el-form-item label="图片" >&ndash;&gt;-->
<!--        &lt;!&ndash;          <div>&ndash;&gt;-->
<!--        &lt;!&ndash;            <el-upload&ndash;&gt;-->
<!--        &lt;!&ndash;                class="avatar-uploader"&ndash;&gt;-->
<!--        &lt;!&ndash;                action="http://localhost:9090/file/upload"&ndash;&gt;-->
<!--        &lt;!&ndash;                :show-file-list="false"&ndash;&gt;-->
<!--        &lt;!&ndash;                :on-success="handleAvatarSuccess"&ndash;&gt;-->
<!--        &lt;!&ndash;                :before-upload="beforeAvatarUpload">&ndash;&gt;-->
<!--        &lt;!&ndash;              <img v-if="form.img" :src="form.img" class="avatar">&ndash;&gt;-->
<!--        &lt;!&ndash;              <i v-else>&ndash;&gt;-->
...
<!--    </el-dialog>-->
    ...
    <el-dialog :visible.sync="refundFormVisible" width="60%" :show-close="false">
      <div style="font-size: 20px; margin-bottom: 40px">
        确认退款吗吗？
      </div>
      <div style="text-align: right">
        <el-button size="medium" type="error" @click="cancelRefund">取消</el-button>
        <el-button size="medium" type="primary" @click="confirmRefund">确定</el-button>
      </div>
    </el-dialog>
  ...
  methods:{
    ...
    confirmRefund(){
      ...
      let user = {
        ...
        account: this.waitCancelSales.totalPrice,
        // points:row.consPoints
      }
      this.request.post("/user/updateSellerAfterSalesAccount", user).then(res => {
            if(res.code === '200') {
      ...
      let buyer = {
        id:this.waitCancelSales.loginId,
        account:this.waitCancelSales.totalPrice
      }
      this.request.post("/user/updateSellerAccount", buyer).then(res => {
        if(res.code === '200'){
      ...
      let form2 ={
        ...
        money:this.waitCancelSales.totalPrice,
        type:"卖家退款",
        sellerId:this.waitCancelSales.userId,
        buyerId:this.waitCancelSales.loginId,
        // sellerName:"nickname"
      }
      ...
      this.form ={
        loginId:this.waitCancelSales.loginId,
        money:this.waitCancelSales.totalPrice,
        type:"买家收到退款",
        sellerId:this.waitCancelSales.userId,
        buyerId:this.waitCancelSales.loginId,
    ...
    load(){
      ...
      this.request.get("/orders/frontPageTransOrders", {
        params:{
