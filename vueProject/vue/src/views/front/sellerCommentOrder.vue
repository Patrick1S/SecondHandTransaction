...
<!--          <el-button slot="reference" type="danger" @click="handleGoodsEvaluate(scope.row)">售后<i class="el-icon-remove-outline"></i></el-button>-->
...
<!--        <el-table-column prop="time" label="加入购物车时间" ></el-table-column>-->
    ...
    <el-dialog title="对当前已购买商品进行评价" :visible.sync="evaluateDialogFormVisible" width="30%">
      <el-form label-width="120px" >
        <el-form-item label="给买家评价" size="small">
          <el-input v-model="form.comment" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="为用户打分">
          <el-input v-model="form.buyerPoints" autocomplete="off"></el-input>
        </el-form-item>
